...
let info = {
    mine: {
        ...
        gain:[5, 15, 50, 250, 1000, 4000, 13000, 50000],
        title:"Mine",
    ...
    solarPanel: {
        ...
        panelCost:[1, 10, 200, 600, 2e3, 30e3, 2e6],
        power:[0, 0, 0, 0, 0, 0, 0],
        gain:[5, 15, 50, 250, 1000, 4000, 13000, 50000],
        title:"Solar Panel",
    ...
    factory: {
        ...
        gain:[.2, .5, 1.5, 5, 18, 50, 180],
        gain2:[.2, .5, 1.5, 5, 18, 50, 180],
        title:"Factory",
